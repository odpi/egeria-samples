...
/**
 * The CocoPagesException is thrown by the connector when it is not possible to retrieve/save the requested entry from LDAP.
 */
public class CocoPagesException extends ConnectorCheckedException
{
     ...
     */
    public CocoPagesException(ExceptionMessageDefinition messageDefinition,
                              String                     className,
