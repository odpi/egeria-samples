...
/**
 * The SecAdminException is thrown by the connector when it is not possible to retrieve/save the requested entry from LDAP.
 */
public class SecAdminException extends ConnectorCheckedException
{
     ...
     */
    public SecAdminException(ExceptionMessageDefinition messageDefinition,
                             String                     className,
