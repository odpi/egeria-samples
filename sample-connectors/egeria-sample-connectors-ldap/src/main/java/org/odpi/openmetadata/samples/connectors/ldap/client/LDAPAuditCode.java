 ...
 * </ul>
 */
public enum LDAPAuditCode implements AuditLogMessageSet
{
    CONNECTION_INITIALIZING("LDAP-CLIENT-0001",
                         OMRSAuditLogRecordSeverity.STARTUP,
                         "Creating connection to the LDAP server host {0} at port {1}",
                         "The LDAP API is creating the connection to the LDAP server and binding it with anonymous access.",
                         "No action is required if the connection is established successfully.  Any failures will be reported as exceptions."),

    SERVICE_PUBLISHING("LDAP-CLIENT-0002",
                       OMRSAuditLogRecordSeverity.STARTUP,
    ...
    SERVICE_INITIALIZED("LDAP-CLIENT-0005",
                        OMRSAuditLogRecordSeverity.STARTUP,
    ...
    SERVICE_SHUTDOWN("LDAP-CLIENT-0006",
    ...
    PUBLISHING_SHUTDOWN("LDAP-CLIENT-0007",
                        OMRSAuditLogRecordSeverity.SHUTDOWN,
    ...
    PUBLISHING_SHUTDOWN_ERROR("LDAP-CLIENT-0008",
                              OMRSAuditLogRecordSeverity.SHUTDOWN,
    ...
    SERVICE_INSTANCE_FAILURE("LDAP-CLIENT-0011",
    ...
    SERVICE_INSTANCE_TERMINATION_FAILURE("LDAP-CLIENT-0012",
                                         OMRSAuditLogRecordSeverity.EXCEPTION,
    ...
    OUT_TOPIC_EVENT("LDAP-CLIENT-0013",
    ...
    PROCESS_EVENT_EXCEPTION("LDAP-CLIENT-0014",
                            OMRSAuditLogRecordSeverity.EXCEPTION,
                            "Event {0} could not be consumed. Error: {1}",
                            "The system is unable to process the request.",
                            "Verify the topic configuration."),

    PARSE_EVENT_EXCEPTION("LDAP-CLIENT-0015",
                          OMRSAuditLogRecordSeverity.EXCEPTION,
     ...
     */
    LDAPAuditCode(String                     messageId,
