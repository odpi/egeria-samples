...
/**
 * LDAPPlatformSecurityConnector overrides the default behavior for the security connector
 ...
 */
public class LDAPPlatformSecurityConnector extends OpenMetadataPlatformSecurityConnector
{
