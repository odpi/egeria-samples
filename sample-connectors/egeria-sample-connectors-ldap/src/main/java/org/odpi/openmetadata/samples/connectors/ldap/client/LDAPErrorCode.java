 ...
 * </ul>
 */
public enum LDAPErrorCode implements ExceptionMessageSet
{
    CREATE_CLIENT_EXCEPTION(400, "LDAP-CLIENT-400-001",
                         "Client for host {0} and port {1} could not be create. Returned {2} exception with message {3}",
                         "The system is unable to initialize the connection to the LDAP Server.",
                         "Verify the host name and port number - also check the server is running."),
    ADD_ENTITY_EXCEPTION(400, "LDAP-CLIENT-400-001",
    ...
    UNEXPECTED_EXCEPTION(503, "LDAP-CLIENT-503-001",
                                        "A {0} exception was caught during method {1} for server {2} at port {3}. The error message was: {4}",
                                        "The system detected an unexpected error during interaction with the LDAP server.",
     ...
     */
    LDAPErrorCode(int  httpErrorCode, String errorMessageId, String errorMessage, String systemAction, String userAction)
    {
