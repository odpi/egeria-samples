...
{
    private static final String archiveFileName = "CocoSustainabilityArchive.json";
    ...
    {
        String validValueSetQName = SimpleCatalogArchiveHelper.VALID_VALUE_SET_TYPE_NAME + ":" + FacilityTypeDefinition.validValueSetName;
