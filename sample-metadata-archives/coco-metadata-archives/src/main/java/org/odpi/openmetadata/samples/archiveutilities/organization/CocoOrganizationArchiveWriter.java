...
{
    private static final String archiveFileName = "CocoOrganizationArchive.json";
        ...
        for (PersonDefinition personDefinition : PersonDefinition.values())
        {
            ...
            if (personDefinition.getEmail() != null)
            {
                archiveHelper.addContactDetails(profileGUID,
                                                ...
                                                SimpleCatalogArchiveHelper.CONTACT_METHOD_TYPE_EMAIL,
    ...
    private void writeOrganizations()
    {
        ...
        {
            archiveHelper.addTeam(SimpleCatalogArchiveHelper.ORGANIZATION_TYPE_NAME,
    ...
    private void writeTeams()
    {
        for (DeptDefinition deptDefinition : DeptDefinition.values())
        {
            ...
            archiveHelper.addPersonRole(SimpleCatalogArchiveHelper.TEAM_LEADER_TYPE_NAME,
                                        leadershipRoleQName,
                                        leadershipRoleQName,
                                        null,
                                        null,
            ...
            archiveHelper.addPersonRole(SimpleCatalogArchiveHelper.TEAM_MEMBER_TYPE_NAME,
                                                                    membershipRoleQName,
                                                                    membershipRoleQName,
                                                                    null,
                                                                    null,
