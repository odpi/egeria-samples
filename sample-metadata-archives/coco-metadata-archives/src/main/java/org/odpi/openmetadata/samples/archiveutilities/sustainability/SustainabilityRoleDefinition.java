...
public enum SustainabilityRoleDefinition
{
    ...
    WINCHESTER_DC_LEADER("LocationOwner",
                         "WINCH-DC-LEADER",
                         "Winchester Data Center Leader",
                         "Leader responsible for the care and compliance of the Winchester Data Center.",
                         ScopeDefinition.WITHIN_FACILITY,
                         true, 1,
                         null,
                         null),
    ...
    WINCHESTER_DEPOT_LEADER("LocationOwner",
                            "WINCH-DEPOT-LEADER",
                            "Winchester Distribution Center Leader",
                            "Leader responsible for the care and compliance of the Winchester Distribution Center.",
                            ScopeDefinition.WITHIN_FACILITY,
                            true, 1,
                            null,
                            null),
    ...
    EDMONTON_DC_LEADER("LocationOwner",
                       "ED-DC-LEADER",
                       "Edmonton Data Center Leader",
                       "Leader responsible for the care and compliance of the Edmonton Data Center.",
                       ScopeDefinition.WITHIN_FACILITY,
                       true, 1,
                       null,
                       null),
    ...
    EDMONTON_DEPOT_LEADER("LocationOwner",
                          "ED-DEPOT-LEADER",
                          "Edmonton Distribution Center Leader",
                          "Leader responsible for the care and compliance of the Edmonton Distribution Center.",
                          ScopeDefinition.WITHIN_FACILITY,
                          true, 1,
                          null,
                          null),
